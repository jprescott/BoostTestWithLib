...
namespace boost
{
	...
	namespace detail
	{
		...
		long const shared_count_id = 0x2C35F101;
		long const   weak_count_id = 0x298C38A4;
		...
		class shared_count
		{
			...
			BOOST_CONSTEXPR shared_count() BOOST_SP_NOEXCEPT:
				pi_(0)
#if defined(BOOST_SP_ENABLE_DEBUG_HOOKS)
				, id_(shared_count_id)
#endif
		...
		class weak_count
		{
			...
			BOOST_CONSTEXPR weak_count() BOOST_SP_NOEXCEPT:
				pi_(0)
#if defined(BOOST_SP_ENABLE_DEBUG_HOOKS)
				, id_(weak_count_id)
#endif
	...
	inline shared_count::shared_count( weak_count const & r, sp_nothrow_tag ) BOOST_SP_NOEXCEPT:
		pi_( r.pi_ )
#if defined(BOOST_SP_ENABLE_DEBUG_HOOKS)
		, id_(shared_count_id)
#endif
